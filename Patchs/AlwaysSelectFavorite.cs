...
namespace Patchs
{
    ...
    class AlwaysSelectFavorite
    {
        ...
        {
            if (ModSettings.GetBool("Randomize in-between games") && (PlayerPrefsUtils.GetValue<bool>("RandomizeCharacter")||ModSettings.GetBool("Randomize in-between games"))) { OtherUtils.RandomizeSkinsNPet(); Console.WriteLine("Randomizing selections"); return;}
